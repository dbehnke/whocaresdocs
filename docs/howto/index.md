...
This section contains step-by-step guides and tutorials for amateur radio activities.
...
### [Filtered DMR Contacts](filtered-dmr-contacts/index.md)

Guide for generating filtered DMR contact lists for Baofeng DM-32UV, Anytone, and OpenGD77 radios to include only active operators.
